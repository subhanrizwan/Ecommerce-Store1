    ...
    <CtaFooter />
      <div className="container">
        ...
        <ul className="pt-5 text-1xl">
          ...
          //   }
          // } 
          className="footer-bottom text-xs w-screen text-center border-t border border-gray-150 bg-gray-100 p-5">
            <p className="mt-1">Copyright @2025 Subhan Ahmed.All Right Reserved</p>
          </div>
