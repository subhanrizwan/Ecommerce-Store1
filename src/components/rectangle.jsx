const Rectangle=()=> {
  ...
  className="
    ...
    before:content-[''] before:absolute before:w-[14px] before:h-[14px] before:rounded-full before:border-2 before:border-secondary  before:top-0 before:left-0 before:transition-all before:animate-moveLeft
