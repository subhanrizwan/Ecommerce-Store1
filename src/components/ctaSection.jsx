...
const CtaFooter = () => {
  return (
    <section className="cta-footer ">
      ...
      <div className="w-2/3 md:w-7/12 sm:w-9/12 flex justify-between flex-wrap md:flex-nowrap sm:flex-nowrap sm:flex-nowrapF bg-gray-100 mx-auto p-9 rounded shadow relative top-11 z-30">
