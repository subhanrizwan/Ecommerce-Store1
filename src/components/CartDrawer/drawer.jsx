          ...
          >
            ...
            >
              ...
              <svg
                ...
                viewBox="0 0 24 24"
                xmlns="http://www.w3.org/2000/svg"
                className="w-[0.9em] h-[0.9em] group-hover:fill-secondary overflow-visible [transition:transform_.35s_ease] group-hover:[transition-delay:.25s] [&_path]:[transition:transform_.35s_ease] group-hover:rotate-45"
              >
                <path
