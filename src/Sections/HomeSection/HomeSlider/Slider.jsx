  ...
  return (
    ...
    >
      {slides.map((slide) => (
        ...
        >
           <div className="content flex flex-col md:flex-row justify-between items-center w-full h-full max-w-7xl mx-auto px-4 md:px-6 lg:px-8">
          {/* Left Content Section */}
          <div className="left flex flex-col justify-center text-center md:text-left flex-1 p-4 py-6 md:p-12 text-black">
